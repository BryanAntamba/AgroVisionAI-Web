...
const agricultorRecomendacionesRoutes = require('./routes/agricultorRecomendacionesRoutes');
...
app.use('/api/agricultor/recomendaciones', agricultorRecomendacionesRoutes);
